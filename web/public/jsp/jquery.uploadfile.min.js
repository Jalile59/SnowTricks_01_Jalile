...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            uploadStr:'<img src="/SnowTricks_01/web/public/img/bouton-modifier_318-77528.png"onclick="mpicture(this)">',
            abortStr: "Abort",
            cancelStr: "Cancel",
            deleteStr: "Delete",
            doneStr: "Done",
	...
	this.enqueueFile = function(file){
		...
		function defaultProgressBar(obj,s)
		{
            ...
            this.filename = $("<div class='ajax-file-upload-filename'></div>").appendTo(' '); // suppression de this.statusbar
